...
Patch26:  apache2.2-mpm-itk-20090414-00.patch
# Bug fixes
...
Conflicts: pcre < 4.0
Requires: httpd-tools = %{epoch}:%{version}-%{release}, apr-util-ldap
...
* Fri Sep 28 2011 DeoGracia <deogracia@free.fr> - 1:2.2.17-1.el6.centos
- update to 2.2.17
- removed httpd-2.2.14-ldapdyngrp.patch

* Fri Sep 27 2011 DeoGracia <deogracia@free.fr> - 1:2.2.16-1.el6.centos
- update to 2.2.16
- disabled httpd-2.2.15-CVE-2010-1452.patch

* Fri Sep 09 2011 DeoGracia <deogracia@free.fr> - 1:2.2.15-1.el6.centos
- add itk patch

* Wed Jun 29 2011 Karanbir Singh <kbsingh@centos.org> - 2.2.15-5.el6.centos
